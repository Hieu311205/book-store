...
export const adminService = {
  ...
  getSalesByAuthor: (limit = 10) => api.get('/admin/dashboard/sales-by-author', { params: { limit } }),
  getSalesByCategory: (limit = 10) => api.get('/admin/dashboard/sales-by-category', { params: { limit } }),
  getSlowMoving: (params = {}) => api.get('/admin/dashboard/slow-moving', { params }),
